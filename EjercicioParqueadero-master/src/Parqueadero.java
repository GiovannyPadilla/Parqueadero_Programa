...
// -----------------------------------------------------------------
 ...
 //Fin metodo 1
    ...
    public int desocuparParqueadero() {
        // Inicializa la variable para contar la cantidad de carros sacados
        ...
        for (int i = 0; i < TAMANO; i++) {
            ...
            if (puestos[i].estaOcupado()) {
                // Si está ocupado, saca el carro del puesto
        ...
        // Retorna la cantidad total de carros sacados
    ...
    public String metodo2() {
        ...
        // Construye un mensaje con la cantidad de puestos libres
